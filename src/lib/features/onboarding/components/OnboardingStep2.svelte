...
<div class="mx-auto w-full py-12 px-6 md:px-93.5">
	<!-- Badge -->
	<div class="mb-4">
		<span
			class="inline-block rounded-full border border-primary/40 bg-primary-50/50 px-3 py-1 font-mono text-xs font-semibold text-primary"
		>
			Langkah 2 dari 3
		</span>
	</div>
	...
	<!-- Heading -->
	<h1 class="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Pengaturan Profil</h1>
